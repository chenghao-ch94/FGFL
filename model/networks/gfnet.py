...
class GFNet(nn.Module):
    ...
    #              dropcls=0):
    def __init__(self, img_size=84, patch_size=16, in_chans=3, embed_dim=768, depth=12,
                 mlp_ratio=4., representation_size=None, uniform_drop=False,
                 drop_rate=0., drop_path_rate=0., norm_layer=None, 
                 dropcls=0):
        """
...
def GFNet12(input_size=84, depth=12):

    model = GFNet(
                img_size=input_size, 
                patch_size=8, embed_dim=384, depth=12, mlp_ratio=4,
