...
def get_command_line_parser():
    ...
    parser.add_argument('--model_class', type=str, default='GAIN_Feat', 
                        choices=['GAIN_Feat', 'ProtoNet']) # None for MatchNet or ProtoNet
    ...
    parser.add_argument('--dataset', type=str, default='MiniImageNet',
                        choices=['MiniImageNet', 'TieredImageNet', 'CUB', 'Domain_FS'])
    ...
    parser.add_argument('--temperature', type=float, default=64.0)
    parser.add_argument('--temperature2', type=float, default=64.0)  # the temperature in the  
    ...
    parser.add_argument('--init_weights', type=str, default='./saves/initialization/miniimagenet/Res12-pre.pth') #./saves/initialization/miniimagenet/Res18-pre.pth
    parser.add_argument('--init_weights2', type=str, default='./checkpoints/MiniImageNet-ProtoNet-Res12-05w01s15q-Pre-DIS/20_0.5_lr0.001mul10_step_T164T264_b0.01_bsz080-NoAugtest_freq_cosnew/max_acc.pth'))
    ...
    parser.add_argument('--tid', type=int, default=0, help='the id of test domain') # only for domain-fs dataset
    return parser
